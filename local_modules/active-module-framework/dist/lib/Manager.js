        ...
        for (let ent of files) {
            ...
            if (!dir) {
                ...
                if (ext === '.js' || (ext === '.ts' && ext2 !== '.d.ts'))
                    r = require(params.modulePath + '/' + name);
            }
            else {
    ...
    initExpress(params) {
        ...
        this.express.all(params.remotePath, async (req, res, next) => {
            ...
            if (cmd != null) {
                ...
                if (!await BaseHtml_1.BaseHtml.output(res, path, params.rootPath, params.indexPath, params.cssPath, params.jsPath, params.jsPriority))
                    next();
            }
        });
    }
